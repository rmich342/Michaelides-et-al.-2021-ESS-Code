...
% (Haversine: https://urldefense.com/v3/__http://en.wikipedia.org/wiki/Haversine_formula__;!!Mih3wA!TPUCufp8eyUAsAT_UTGKZOfOnULrbAAA79LFpzUWRwKo9vewHNNytsEW7vXudt-w$ )
% d2km: distance in km based on Pythagoras theorem
% (see: https://urldefense.com/v3/__http://en.wikipedia.org/wiki/Pythagorean_theorem__;!!Mih3wA!TPUCufp8eyUAsAT_UTGKZOfOnULrbAAA79LFpzUWRwKo9vewHNNytsEW7mHKkdgs$ )
% After:
% https://urldefense.com/v3/__http://www.movable-type.co.uk/scripts/latlong.html__;!!Mih3wA!TPUCufp8eyUAsAT_UTGKZOfOnULrbAAA79LFpzUWRwKo9vewHNNytsEW7lwbjeka$ 
%
% --Inputs:
